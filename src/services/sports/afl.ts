// ==========================================
// SERVICE AFL (Australian Football League)
// ==========================================
...
const HOST = 'v1.afl.api-sports.io'

const PRIORITY_LEAGUE_IDS = [1] // AFL = league 1
const FINISHED_STATUSES = ['FT']
const VALID_STATUSES = ['NS', 'Q1', 'Q2', 'Q3', 'Q4', 'BT', 'FT', 'CANC', 'POST']
...
export const aflService = { getMatchesByDate, getPriorityMatches }
