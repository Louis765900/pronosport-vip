...
const PRIORITY_LEAGUE_IDS = [17, 30, 1] // Six Nations=17, Top 14=30, World Cup=1
const FINISHED_STATUSES = ['FT', 'AOT']
const VALID_STATUSES = ['NS', '1H', 'HT', '2H', 'ET', 'BT', 'FT', 'AOT', 'CANC', 'POST']
...
export const rugbyService = { getMatchesByDate, getPriorityMatches }
